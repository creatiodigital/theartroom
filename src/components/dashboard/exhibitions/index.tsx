  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '1000px', margin: '0 auto' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '2rem' }}>
        <div>
          <Link href="/dashboard" style={{ color: '#666', textDecoration: 'none', fontSize: '0.875rem' }}>← Back to Dashboard</Link>
          <h1 style={{ margin: '0.5rem 0 0', fontSize: '1.75rem' }}>My Exhibitions</h1>
        </div>
        <div style={{ display: 'flex', gap: '0.5rem' }}>
          <Button variant="small" label="+ New Exhibition" onClick={() => {/* TODO */}} />
