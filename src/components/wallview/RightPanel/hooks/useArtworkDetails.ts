...
export const useArtworkDetails = (currentArtworkId: string) => {
  ...
  if (!artwork || !artworkPosition) {
    return {
      ...
      frameTextureOffsetX: 0,
      frameTextureOffsetY: 0,
      frameTextureRotation: 0,
      frameTextureRoughness: 0.6,
      frameTextureTemperature: 0,
  ...
  return {
    ...
    frameTextureOffsetX: frameTextureOffsetX ?? 0,
    frameTextureOffsetY: frameTextureOffsetY ?? 0,
    frameTextureRotation: frameTextureRotation ?? 0,
    frameTextureRoughness: frameTextureRoughness ?? 0.6,
    frameTextureTemperature: frameTextureTemperature ?? 0,
    showPassepartout,
    passepartoutColor,
