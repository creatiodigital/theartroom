      ...
      const positions = allArtworkIds
        ...
        .map((id) => {
          ...
          return {
            ...
            frameThickness: artwork.frameThickness?.value ?? 2,
            ...
            passepartoutThickness: artwork.passepartoutThickness?.value ?? 0.6,
            showPaperBorder: artwork.showPaperBorder ?? false,
            paperBorderSize: artwork.paperBorderSize?.value ?? 0,
            supportThickness: artwork.supportThickness?.value ?? 2,
            ...
            textPaddingTop: artwork.textPaddingTop?.value ?? 0,
            textPaddingBottom: artwork.textPaddingBottom?.value ?? 0,
            textPaddingLeft: artwork.textPaddingLeft?.value ?? 0,
            textPaddingRight: artwork.textPaddingRight?.value ?? 0,
            textThickness: artwork.textThickness?.value ?? 0,
            textBackgroundTexture: artwork.textBackgroundTexture ?? null,
            showTextBorder: artwork.showTextBorder ?? false,
            textBorderColor: artwork.textBorderColor ?? '#c9a96e',
            textBorderOffset: artwork.textBorderOffset?.value ?? 1.2,
            showMonogram: artwork.showMonogram ?? false,
