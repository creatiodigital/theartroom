    ...
    <div className={className}>
      ...
      {isOpen && (
        <div className={styles.options}>
          <a
            href={`mailto:?subject=${encodeURIComponent(`${title} — The Art Room`)}&body=${encodeURIComponent(url)}`}
