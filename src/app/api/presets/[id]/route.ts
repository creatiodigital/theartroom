  ...
  try {
    ...
    const updated = await prisma.artworkPreset.update({
      ...
      data: {
        ...
        frameThickness: body.frameThickness != null ? Number(body.frameThickness) : preset.frameThickness,
        // Passepartout
        ...
        passepartoutSize: body.passepartoutSize != null ? Number(body.passepartoutSize) : preset.passepartoutSize,
        passepartoutThickness: body.passepartoutThickness != null ? Number(body.passepartoutThickness) : preset.passepartoutThickness,
        // Support
        showSupport: body.showSupport ?? preset.showSupport,
        supportThickness: body.supportThickness != null ? Number(body.supportThickness) : preset.supportThickness,
        ...
        letterSpacing: body.letterSpacing != null ? Number(body.letterSpacing) : preset.letterSpacing,
        lineHeight: body.lineHeight != null ? Number(body.lineHeight) : preset.lineHeight,
        textColor: body.textColor ?? preset.textColor,
        textBackgroundColor: body.textBackgroundColor !== undefined ? body.textBackgroundColor : preset.textBackgroundColor,
        ...
        textPaddingTop: body.textPaddingTop != null ? Number(body.textPaddingTop) : preset.textPaddingTop,
        textPaddingBottom: body.textPaddingBottom != null ? Number(body.textPaddingBottom) : preset.textPaddingBottom,
        textPaddingLeft: body.textPaddingLeft != null ? Number(body.textPaddingLeft) : preset.textPaddingLeft,
        textPaddingRight: body.textPaddingRight != null ? Number(body.textPaddingRight) : preset.textPaddingRight,
        ...
        showTextBorder: body.showTextBorder !== undefined ? body.showTextBorder : preset.showTextBorder,
        textBorderColor: body.textBorderColor ?? preset.textBorderColor,
        textBorderOffset: body.textBorderOffset != null ? Number(body.textBorderOffset) : preset.textBorderOffset,
        ...
        monogramOpacity: body.monogramOpacity != null ? Number(body.monogramOpacity) : preset.monogramOpacity,
        monogramPosition: body.monogramPosition ?? preset.monogramPosition,
        monogramOffset: body.monogramOffset != null ? Number(body.monogramOffset) : preset.monogramOffset,
